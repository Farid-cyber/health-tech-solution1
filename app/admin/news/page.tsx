...
const Doctors = () => {
  ...
  const [xabar, setXabar] = useState<Xabar>({
    author: "",
    title: "",
    description: "",
    createdAt: "",
  ...
  return (
    <div className="doctors-page-wrapper">
      ...
      <div className="button2-wrapper">
        <button onClick={() => setOpen(true)}>Add Xabar</button>
      </div>
      <div
        style={{ padding: "10px" }}
      ...
      >
        <div className="mt-4 rodal-body-scroll">
          ...
          <div className="mt-2 rodal-inside">
            <label htmlFor="image">Image of Xabar</label>
            <input
              className="form-control mt-2"
              type="file"
              onChange={(e) =>
